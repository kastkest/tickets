...
public class Tickets {
    ...
    public static Tickets jsonToJava() {
        String jsonString = "{\n" +
                "  \"tickets\": [{\n" +
                "    \"origin\": \"VVO\",\n" +
    ...
    public List<Long> createFlightTimeList(List<Ticket> ticketList) {
    ...
    public String findAvgFlightTime(List<Long> flightTime) {
    ...
    public String percentile(List<Long> list, double percentile) {
